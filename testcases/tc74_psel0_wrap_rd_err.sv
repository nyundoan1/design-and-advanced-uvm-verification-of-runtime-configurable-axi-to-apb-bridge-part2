`ifndef TC74_PSEL0_WRAP_RD_ERR_SV
`define TC74_PSEL0_WRAP_RD_ERR_SV

class tc74_psel0_wrap_rd_err extends apb_base_test;

  `uvm_component_utils(tc74_psel0_wrap_rd_err)

  function new(string name = "tc74_psel0_wrap_rd_err", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TC74", "Starting TC74 : PSEL0 WRAP READ ERROR", UVM_LOW)
    ...
    if (!seq.randomize() with {
      ...
      `uvm_error("TC74", "Sequence randomization failed!")
    end
    ...
    `uvm_info("TC74", "Finished TC74 : PSEL0 WRAP READ ERROR", UVM_LOW)
