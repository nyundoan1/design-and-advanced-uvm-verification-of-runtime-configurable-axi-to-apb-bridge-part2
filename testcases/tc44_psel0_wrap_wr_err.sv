`ifndef TC44_PSEL0_WRAP_WR_ERR_SV
`define TC44_PSEL0_WRAP_WR_ERR_SV

class tc44_psel0_wrap_wr_err extends apb_base_test;

  `uvm_component_utils(tc44_psel0_wrap_wr_err)

  function new(string name = "tc44_psel0_wrap_wr_err", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TC44", "Starting TC44 : PSEL0 WRAP WRITE ERROR", UVM_LOW)
    ...
    if (!seq.randomize() with {
      ...
      `uvm_error("TC44", "Sequence randomization failed!")
    end
    ...
    `uvm_info("TC44", "Finished TC44 : PSEL0 WRAP WRITE ERROR", UVM_LOW)
