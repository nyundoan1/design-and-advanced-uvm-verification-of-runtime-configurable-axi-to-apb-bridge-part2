`ifndef TC34_PSEL0_INCR_WR_ERR_SV
`define TC34_PSEL0_INCR_WR_ERR_SV

class tc34_psel0_incr_wr_err extends apb_base_test;

  `uvm_component_utils(tc34_psel0_incr_wr_err)

  function new(string name = "tc34_psel0_incr_wr_err", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TC34", "Starting TC34 : PSEL0 INCR WRITE ERROR", UVM_LOW)
    ...
    if (!seq.randomize() with {
      ...
      `uvm_error("TC34", "Sequence randomization failed!")
    end
    ...
    `uvm_info("TC34", "Finished TC34 : PSEL0 INCR WRITE ERROR", UVM_LOW)
