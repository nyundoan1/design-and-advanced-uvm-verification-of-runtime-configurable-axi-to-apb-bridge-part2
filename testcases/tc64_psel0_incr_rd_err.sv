`ifndef TC64_PSEL0_INCR_RD_ERR_SV
`define TC64_PSEL0_INCR_RD_ERR_SV

class tc64_psel0_incr_rd_err extends apb_base_test;

  `uvm_component_utils(tc64_psel0_incr_rd_err)

  function new(string name = "tc64_psel0_incr_rd_err", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TC64", "Starting TC64 : PSEL0 INCR READ ERROR", UVM_LOW)
    ...
    if (!seq.randomize() with {
      ...
      `uvm_error("TC64", "Sequence randomization failed!")
    end
    ...
    `uvm_info("TC64", "Finished TC64 : PSEL0 INCR READ ERROR", UVM_LOW)
