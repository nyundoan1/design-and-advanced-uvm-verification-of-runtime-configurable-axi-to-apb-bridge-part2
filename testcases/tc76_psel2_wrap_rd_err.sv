`ifndef TC76_PSEL2_WRAP_RD_ERR_SV
`define TC76_PSEL2_WRAP_RD_ERR_SV

class tc76_psel2_wrap_rd_err extends apb_base_test;

  `uvm_component_utils(tc76_psel2_wrap_rd_err)

  function new(string name = "tc76_psel2_wrap_rd_err", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info("TC76", "Starting TC76 : PSEL2 WRAP READ ERROR", UVM_LOW)
    ...
    if (!seq.randomize() with {
      ...
      `uvm_error("TC76", "Sequence randomization failed!")
    end
    ...
    `uvm_info("TC76", "Finished TC76 : PSEL2 WRAP READ ERROR", UVM_LOW)
