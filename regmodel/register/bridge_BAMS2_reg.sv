class bridge_BAMS2_reg extends uvm_reg;
  `uvm_object_utils(bridge_BAMS2_reg)

  uvm_reg_field Base;
  uvm_reg_field Rsvd;
  uvm_reg_field Size;

  function new(string name="bridge_BAMS2_reg");
  ...
  virtual function void build();
    ...
    Base.configure(this, 22, 10, "RW", 0, 22'h8, 1, 0, 0);
